1. [[Cómo activar algunas de las tareas de preprocesamiento mencionadas en Python utilizando NLTK|tokenizacion]]: dividir el texto en tokens (palabras o frases) para que el modelo pueda procesarlo.
